...
# This notebook and the accompanying code demonstrates how to use the Graph
# Nets library to learn to predict the shortest path between two nodes in graph.
# 
# The network is trained to label the nodes and edges of the shortest path,
# given the start and end nodes.
# 
# After training, the network's prediction ability is illustrated by comparing
# its output to the true shortest path. Then the network's ability to
# generalise is tested, by using it to predict the shortest path in similar but
# larger graphs.
...
def graph_to_input_target(graph):
  ...
  for node_index, node_feature in graph.nodes(data=True):
    cfeat = create_feature(node_feature, input_node_fields)
    # print(node_feature)
    # print(cfeat)
    input_graph.add_node(
        node_index, features=cfeat)
...
print("Saving figure...")
plt.savefig('imgs/graph_w_soln.png', dpi=fig.dpi)
plt.close(fig)
...
print("Saving figure...")
plt.savefig('imgs/training_curves.png', dpi=fig.dpi)
plt.close(fig)
print("Done saving figure.")
...
print("Saving figure...")
plt.savefig('imgs/test_values.png', dpi=fig.dpi)
plt.close(fig)
print("Done saving figure.")
